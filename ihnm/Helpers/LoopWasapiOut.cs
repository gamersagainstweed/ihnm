...
public class LoopWasapiOut : IWavePlayer, IDisposable, IWavePosition
{
    ...
    public LoopWasapiOut(AudioClientShareMode shareMode, int latency)
    ...
    //   latency:
    //     Desired latency in milliseconds
    public LoopWasapiOut(AudioClientShareMode shareMode, bool useEventSync, int latency)
    ...
    //   latency:
    //     Desired latency in milliseconds
    public LoopWasapiOut(MMDevice device, AudioClientShareMode shareMode, bool useEventSync, int latency)
    {
